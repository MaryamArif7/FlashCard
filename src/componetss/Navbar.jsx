...
export default function Navbar() {
  return (
    <nav className="relative bg-black rounded-full border border-transparent dark:bg-white dark:border-white/[0.2] shadow-input flex justify-center space-x-4 px-8 py-6">
